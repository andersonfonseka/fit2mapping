...
import br.fit2mapping.diagram.toolbar.RequirementDiagramToolbar;

@SuppressWarnings("serial")
public class RequirementDiagramEditor extends DiagramEditor {
	
	private static Integer counter =1;
	
	RequirementDiagram diagram = new RequirementDiagram(this);
	
	public RequirementDiagramEditor() {
		
		super();
		
		setTitle("RequirementFigure Diagram " + counter++);
		...
		RequirementDiagramToolbar diagramToolbar = new RequirementDiagramToolbar(diagram);
